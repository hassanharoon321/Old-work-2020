...
var expenses = [];
var header = "<tr>" +
    "<td style='width: 70px; color: orange;'>" + "<b>" + "Date" + "</b>" + "</td>" +
    "<td style='width: 100px; color: orange;'>" + "<b>" + "Category" + "</b>" + "</td>" +
    "<td style='color: orange;'>" + "<b>" + "Amount" + "</b>" + "</td>" +
    "<td>" + "</td>" +
    "<td style='color: orange;'>" + "<b>" + "Edit" + "</b>" + "</td>" +
